export const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "AIzaSyDY1askpWIaD9jssdPp4zC7lu8Syz8UOB4",
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "studio-6468065292-dc3aa.firebaseapp.com",
